...
//===----------------------------------------------------------------------===//
//
// This file defines the generic MyProfileInfo interface, which is used as the
...
// MyProfileInfo, which requires that they notify it when changes to the CFG are
// made. (This is not implemented yet.)
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_ANALYSIS_MYPROFILEINFO_H
#define LLVM_ANALYSIS_MYPROFILEINFO_H
...
namespace llvm {
  ...
  /// MyProfileInfo Class - This class holds and maintains profiling
  /// information for some unit of code.
  template<class FType, class BType>
  class MyProfileInfoT {
  public:
  ...
  protected:
    ...
    MyProfileInfoT<MachineFunction, MachineBasicBlock> *MachineProfile;
  public:
    /*static char ID; // Class identification, replacement for typeinfo*/
    MyProfileInfoT();
    ~MyProfileInfoT();  // We want to be subclassed
    ...
    static const FType* getFunction(Edge e) {
      ...
      llvm_unreachable("Invalid MyProfileInfo::Edge");
    }
    ...
    void dump(FType *F = 0, bool real = true) {
      dbgs() << "**** This is MyProfileInfo " << this << " speaking:\n";
      if (!real) {
      ...
      dbgs() << "**** MyProfileInfo " << this << ", over and out.\n";
    }
    ...
    MyProfileInfoT<MachineFunction, MachineBasicBlock> *MI() {
      if (MachineProfile == 0)
        MachineProfile = new MyProfileInfoT<MachineFunction, MachineBasicBlock>();
  ...
  typedef MyProfileInfoT<Function, BasicBlock> MyProfileInfo;
  typedef MyProfileInfoT<MachineFunction, MachineBasicBlock> MachineMyProfileInfo;

  /// createProfileLoaderPass - This function returns a Pass that loads the
  /// profiling information for the module from the specified filename, making
  /// it available to the optimizers.
  /*Pass *createMyProfileLoaderPass(const std::string &Filename);*/

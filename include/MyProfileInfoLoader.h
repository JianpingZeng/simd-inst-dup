...
#ifndef LLVM_ANALYSIS_MYPROFILEINFOLOADER_H
#define LLVM_ANALYSIS_MYPROFILEINFOLOADER_H
...
public:
  ...
  MyProfileInfoLoader(const char *ToolName, const std::string &Filename);
